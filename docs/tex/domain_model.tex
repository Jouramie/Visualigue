...
Cette section présente le modèle du domaine de VisuaLigue. La figure \ref{fig:domain_model} présente une vue globable de l'application.
...
Le point d'entrée est l'utilisateur. Celui-ci peut être une Entraineur, un Joueur ou un Parent. Dans ce diagramme, on prend en considération que l'utilisateur est un Entraineur, car il peut exécuter toutes les actions.
