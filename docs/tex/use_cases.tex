...
La figure \ref{fig:use_cases} représente l'interaction des acteurs avec le système VisuaLigue. Le diagramme est relativement simple, car l'entraineur exécute les différentes actions avec le système, alors que les parents et les joueurs n'ont accès qu'à certaines fonctionnalités.
...
Chaque cas d'utilisation est détaillé par une ficher complète dans les prochains paragraphes. Un diagramme de séquence système suit chaque cas d'utilisation afin de décrire visuellement le scénario principal.

\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{{"fig/diagrams/Diagramme de cas d'utilisation"}.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{{"fig/diagrams/Cas 1 - Creer une strategie"}.png}
	\caption{Diagramme du cas d'utilisation « Créer une stratégie »}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{{"fig/diagrams/Cas 2 - Enregistrer une strategie"}.png}
	\caption{Diagramme du cas d'utilisation « Enregistrer une stratégie »}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{{"fig/diagrams/Cas 3 - Charger une strategie"}.png}
	\caption{Diagramme du cas d'utilisation « Charger une stratégie »}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{{"fig/diagrams/Cas 4 - Visualiser une strategie"}.png}
	\caption{Diagramme du cas d'utilisation « Visualiser une stratégie »}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{{"fig/diagrams/Cas 5 - Placer les elements"}.png}
	\caption{Diagramme du cas d'utilisation « Placer les éléments »}
	\label{fig:use_case_5}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{{"fig/diagrams/Cas 6 - Modifier les trajectoires des elements mobiles image par image"}.png}
	\caption{Diagramme du cas d'utilisation « Modifier les trajectoires des éléments mobiles image par image »}
	\label{fig:use_case_6}
\end{figure}
...
\begin{longtable}{|p{16cm}|}
	...
	\\
	\textbf{Principal scénario de succès :}\\
	1. Entraineur démarre le processus d'enregistrement en temps réel.\\
	...
	*a. Entraineur souhaite arrêter l'enregistrement.\\
	...
	4a. Entraineur souhaite réenregistrer la trajectoire.\\
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{{"fig/diagrams/Cas 7 - Modifier les trajectoires des elements mobiles en temps reel"}.png}
	\caption{Diagramme du cas d'utilisation « Modifier les trajectoires des éléments mobiles en temps réel »}
	\label{fig:use_case_7}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{{"fig/diagrams/Cas 8 - Configurer les types de sports"}.png}
	\caption{Diagramme du cas d'utilisation « Configurer les types de sports »}
	\label{fig:use_case_8}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{{"fig/diagrams/Cas 9 - Configurer les obstacles"}.png}
	\caption{Diagramme du cas d'utilisation « Configurer les obstacles »}
	\label{fig:use_case_9}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{{"fig/diagrams/Cas 10 - Exporter une strategie en format image"}.png}
	\caption{Diagramme du cas d'utilisation « Exporter une stratégie en format image »}
	\label{fig:use_case_10}
\end{figure}
