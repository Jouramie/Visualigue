...
\TitreRapport{Document de conception -- Remise 2}
...
\begin{document}
\input{tex/diag_classe}
\input{tex/diag_sequence}
\input{tex/echeancier2}
	
% Annexes
\appendix
\input{tex/vision}
\input{tex/use_cases}
%\input{tex/supplementary_specification}
\input{tex/domain_model}
%\input{tex/mockup}
%\input{tex/echeancier}
\input{tex/glossaire}
