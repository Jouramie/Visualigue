...
Cette section présente des images tirées de l'application. Les fenêtres d'édition des balles et des obstacles ne sont pas présentées, car elles sont similaires à la fenêtre d'édition des catégories de joueurs.

\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{{"fig/diagrams4/FenetreDAccueil"}.png}
	\caption{Capture de la fenêtre d'accueil}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{{"fig/diagrams4/FenetreDEdition"}.png}
	\caption{Capture de la fenêtre d'édition de stratégie}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{{"fig/diagrams4/FenetreSport"}.png}
	\caption{Capture de la fenêtre d'édition des sports}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{{"fig/diagrams4/FenetreJoueur"}.png}
	\caption{Capture de la fenêtre d'édition des catégories de joueurs}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{{"fig/diagrams4/Diagramme de classe"}.jpg}
