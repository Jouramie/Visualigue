...
Cette section présente les points forts et les points faibles de l'application. Il sera question des améliorations possibles afin que l'application puisse être utilisée en contexte réel ainsi que ce qui pourrait la rendre plus efficace.
